...
import { Search, Plus, Eye, Edit2, Trash2, X, Building2, TrendingUp, CheckCircle, Filter, ArrowUpDown } from "lucide-react";
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mt-1">Kelola data unit kerja dan eselon</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-sm font-medium mb-1">Total Unit Kerja</p>
          ...
          >
            <div className="flex items-center justify-between h-full">
              <div>
                <p className="text-blue-100 text-sm font-medium mb-1">Tambah Unit Kerja</p>
                  ...
                  {filteredData.length > 0 ? (
                    filteredData.map((u, index) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <span className={`px-4 py-1.5 rounded-full text-xs font-semibold inline-flex items-center gap-1 border ${getEselonColor(u.eselon)}`}>
                            {u.eselon}
                          </span>
                        </td>
                        <td className="p-4">
                    ...
                    <tr>
                      <td colSpan={5} className="p-12 text-center">
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <p className="text-gray-500 font-medium">Tidak ada data unit kerja</p>
                ...
                {popup.mode === "view" && popup.data && (
                  <>
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="bg-gray-50 rounded-2xl p-4">
                        <p className="text-xs text-gray-500 mb-1">Nama Unit Kerja</p>
                    ...
                    <div className="bg-gradient-to-r from-red-500 to-pink-600 p-6 text-white">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <h2 className="text-2xl font-bold">Hapus Unit Kerja</h2>
                        </div>
                        <button onClick={closePopup} className="p-2 hover:bg-white/20 rounded-xl transition-colors">
                          <X className="w-6 h-6" />
                        </button>
